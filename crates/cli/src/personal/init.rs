...
pub async fn run_init(output_path: &str) -> Result<()> {
    ...
    if path.exists() {
        ...
        if !overwrite {
            println!("{}", style::warn("Init cancelled. Existing file was not modified."));
            return Ok(());
        }
    }
    ...
    println!();
    println!(
        "This wizard will guide you through creating a personal sync configuration."
    );
    println!(
        "The resulting TOML file can be used with `gitsvnsync personal start`."
    );
    println!();
    ...
    println!(
        "    Name           : {}",
        value_style.apply_to(&dev_name)
    );
    println!(
        "    Email          : {}",
        value_style.apply_to(&dev_email)
    );
    println!(
        "    SVN username   : {}",
    ...
    println!(
        "    Import mode    : {}",
        value_style.apply_to(import_mode)
    );
    println!();
    println!(
...
# Documentation: https://github.com/your-org/gitsvnsync/blob/main/docs/personal-branch/configuration.md
...
"##,
    ...
    println!();
    println!(
        "  1. Set the environment variables referenced above:"
    );
    println!(
        "       export {}=\"your-svn-password\"",
        svn_password_env
    );
    println!(
    ...
    println!(
        "       gitsvnsync personal start --config {}",
        output_path
    );
    println!();
